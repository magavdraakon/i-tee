class UsersController < ApplicationController
  ...
  def index
    ...
    @users = User.select('id, username, role, last_sign_in_ip, last_sign_in_at, ldap, email, authentication_token, token_expires').order(@order).paginate(:page=>params[:page], :per_page=>@per_page)
  end

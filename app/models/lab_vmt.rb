class LabVmt < ActiveRecord::Base
  ...
  has_many :lab_vmt_storages, :dependent => :destroy
  ...
  accepts_nested_attributes_for :lab_vmt_storages,:reject_if => proc { |attributes| attributes['port'].blank? || attributes['storage_id'].blank? }, :allow_destroy => true
